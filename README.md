...
```
git clone https://github.com/AnonymousAuthor1111/ICDCS26.git
...
2. Run index construction (the time of each step will show in the last line of terminal output)
   a. Partition: build/executeDiskPartition
     ...
     ```
   b. Build:
      1. Run [src/indexBuild/generateConfig.sh](https://github.com/AnonymousAuthor1111/ICDCS26/blob/main/src/indexBuild/generateConfig.sh) to generate build configuration
      ...
      2. Run [src/indexBuild/SequentialAssign.sh](https://github.com/AnonymousAuthor1111/ICDCS26/blob/main/src/indexBuild/SequentialAssign.sh) for building using one GPU, or [src/indexBuild/AssignByAvailGPU.sh](https://github.com/AnonymousAuthor1111/ICDCS26/blob/main/src/indexBuild/AssignByAvailGPU.sh) for multi-GPU parallelism
...
Build data with details are in folder [experiments](https://github.com/AnonymousAuthor1111/ICDCS26/tree/main/experiments).
## Search experiments
We record full search results including recall, time and query latency in [search results](https://github.com/AnonymousAuthor1111/ICDCS26/blob/main/SearchResult.xlsx). 
For more details, also see in folder [experiments](https://github.com/AnonymousAuthor1111/ICDCS26/tree/main/experiments).
